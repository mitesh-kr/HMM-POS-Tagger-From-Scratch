...
- `hmm_tagger.py`: Contains the main HMM implementation with the Viterbi algorithm
- `data_utils.py`: Utility functions for loading, preprocessing, and splitting data
- `evaluation.py`: Functions for evaluating the tagger's performance
- `main.py`: Main script that runs the experiments with different configurations
- `README.md`: This file
